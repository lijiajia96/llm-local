...
export const BUILTIN_AGENT_PROFILES: AgentProfile[] = [
  ...
  },
  {
    ...
    skillIds: ["core-agent", "engineering-discipline", "data-analysis", "diagramming"],
    allowedTools: ["run_js", "code_mode", "get_time", "render_mermaid", "memory_search"],
    maxSteps: 8,
    enabled: true,
    builtin: true,
    createdAt: timestamp,
  ...
  },
  {
    ...
    skillIds: ["core-agent", "engineering-discipline", "github-research", "data-analysis"],
    allowedTools: ["github_search", "fetch_url", "run_js", "code_mode", "memory_search"],
    maxSteps: 8,
    enabled: true,
    builtin: true,
    createdAt: timestamp,
  ...
  },
  {
    id: "minimal",
    name: "minimal",
    displayName: "极简 Agent",
    description: "只使用时间与 JavaScript 计算工具，用于裸测模型的推理和工具调用能力。",
    aliases: ["bare", "极简"],
    rolePrompt: "You are running in Minimal mode. Solve the task with the smallest possible tool surface. Do not assume access to web search, durable memory, diagrams, or Code Mode.",
    skillIds: ["core-agent"],
    allowedTools: ["get_time", "run_js"],
    maxSteps: 4,
    enabled: true,
    builtin: true,
    createdAt: timestamp,
